...
import os
import datetime
from models.light_dynamic_memory_network import DynamicMemoryNetwork
...
tf.app.flags.DEFINE_integer("max_sentence_len", 120, "length of the sentence")
...
model_option = "DynamicMemoryNetwork"

"""Advanced Configuration"""
"""
    "inference_hops": 2, "the number of inference hops"
    input_represent_opt: "input representation: Direct/Bidirectional_GRU/Forward_GRU/CNN"
...
with tf.Session() as sess:
    ...
    for epoch in range(1, FLAGS.max_epochs+1):
        ...
        plot_index = range(0, 20)
        # for num_hop in range(hop_tmp):
        for num_hop in [1,]:
            plot_path = "./data" + "//tmp" + "//epoch" + str(epoch) + "//hop" + str(num_hop)
